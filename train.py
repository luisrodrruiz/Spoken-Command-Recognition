...
class SpeechModelTrainer:
    def __init__(self, train_file, dev_file, audio_path = '', batch_size = 16, learning_rate = 0.0001, model = 'cnn', out_dir = '/tmp'):
        ...
        dev_dataset = AudioDataset(dev_file, audio_path = audio_path, label_map = train_dataset.label_map)
    ...
    def train(self,n_epochs = 200):
        ...
        for epoch in range(n_epochs):            
            ...
            print('EPOCH %d. Train: loss = %5.5f accuracy = %5.1f.  Dev:  loss = %5.5f accuracy = %5.1f' %(epoch, train_loss, 100*train_accuracy, dev_loss, 100*dev_accuracy))
